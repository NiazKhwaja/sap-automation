...
if [ -z $id ]; then
  ...
  az repos import create --git-url https://github.com/NiazKhwaja/sap-automation-bootstrap.git --org  $ADO_ORGANIZATION --project $id --repository $repo_id --output none
